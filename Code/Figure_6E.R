...
pdf(file="~/Dropbox/Current_Biology/Gmouse-Nav1.4/Figures/Figure_6/Figure_6E.pdf")
...
lineplot.CI(beta2$Voltage[beta2$Species == species2], beta2$Conductance_Norm[beta2$Species == species2], 
            ...
            col = "blue", lwd = 1.5, bty = 'n', xlab = "", type = "b",
            ylab = "", x.cont = T, xaxt = "n", yaxt = "n",
            x.leg = -80, y.leg = 0.8,  
...
legend(x = -52, y = 0.6 + 0.05, pch = 9, legend = "NoC", col = color, bty = "n", cex = 1.8,  x.intersp = 0.4)
legend(x = -52, y = 0.55 + 0.05, pch = 8, legend = "NoC + Venom", col = color, bty = "n", cex = 1.8,  x.intersp = 0.4)
